define([
	...
	'./hostobjects',
	'./mutationObserver'
], function (log, nodeTest, objObserver, Hostobjects) {
	'use strict';
	...
	function _clone(obj) {
		...
		if ((Object.prototype.toString.call(obj) === '[object Array]') ||
			(obj && nodeTest.isElement(obj) && obj.nodeName === 'tArray')) {
				ret = !nodeTest.isElement(obj) ? new hObj.Array() : hObj.document.createElement('tArray');
				for (var i = 0, l = obj.length; i < l; i++) {
					ret[i] = _clone(obj[i]);
				}
		} else if ((typeof obj === 'object') ||
			(obj && nodeTest.isElement(obj) && obj.nodeName === 'tObject')) {
			ret = !nodeTest.isElement(obj) ? {} : hObj.document.createElement('tObject');
